...
$id = filter_input(INPUT_POST, 'id', FILTER_SANITIZE_NUMBER_INT);
                $sql3 = mysqli_query($conn, "SELECT usuario.*, teste.* FROM usuario INNER JOIN teste ON usuario.id = teste.id_usuario INNER JOIN rh ON teste.id_empresa = rh.id where usuario.id = '$id' ORDER BY usuario.id DESC  ");
