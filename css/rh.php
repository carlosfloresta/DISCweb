        ...
        <h2>Candidatos que já efetuaram o teste</h2>
         ...
         <div class="container">
                    ...
                    <div class="header_wrap">
                        ...
                        <div class="tb_search">
                            <input type="text" id="search_input_all" onkeyup="FilterkeyWord_all_table()" placeholder="Pesquisar..." class="form-control">
                        ...
                        <input type="radio" id="dominante" name="todos" value="dominante"><label style="color:#fff;font-size: 14px" >Dominante</label>
                        <input type="radio" id="influente" name="todos" value="influente" ><label style="color:#fff;font-size: 14px" >Influente</label>
                        <input type="radio" id="estavel" name="todos" value="estavel"><label style="color:#fff;font-size: 14px" >Estável</label>
                        <input type="radio" id="cauteloso" name="todos" value="cauteloso"><label style="color:#fff;font-size: 14px" >Cauteloso</label>
                    </div>
...
<script>
   ...
   //btn ver
    ...
    $('.table').on("click", '#btn_ver', function () {
        ...
        $.post('funcoes/verteste.php', {acao: 'form_ver', id: id}, function (retorno) {
