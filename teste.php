...
<body>
    ...
    <form id="form" method="POST" action="funcoes/cadastrateste.php">
        ...
        <button class="botao2" type="submit"
            style=" display: none; position: fixed; left: 50%;  transform: translate(-50%, -50%);" id="finalizar">Enviar
            Teste</button>
    ...
    function proximapagina() {
        ...
        if ((quadradomais.checked || triangulomais.checked || musicamais.checked || z2mais.checked || nmais.checked ||
                n2mais.checked) && (quadradomenos.checked || triangulomenos.checked || musicamenos.checked || z2menos
                .checked || nmenos.checked || n2menos.checked)) {
            count++;
        }
