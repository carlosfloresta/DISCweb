...
<body>
    ...
    <div id="disc" class="scrollDisc">
        ...
        <div class="disc">
            ...
            <div class="discmouse">
                ...
                <a class="estabilidade"
                    onclick="mostraEstabilidade()">E<br>s<br>t<br>a<br>b<br>i<br>l<br>i<br>d<br>a<br>d<br>e</a>
    ...
    <div class="modaldominancia" id="modaldominancia">
        <div class="scrollop">
            ...
            <p>Frase: “Eu sei o que eu quero”<br>
                ...
                São pessoas que possuem mais facilidade em lidar com desafios, pois são determinadas, exigentes, ousadas
                e assertivas. Por outro lado, essas pessoas não são muito atenciosas com os sentimentos e necessidades
                dos outros, podendo se tornar egoístas.</p>
        </div>
    </div>
    ...
    <div class="modalinfluencia" id="modalinfluencia">
        <div class="scrollop">
            ...
            <p>Frase: “Juntos somos mais fortes”<br>
                ...
                São pessoas mais emocionais e que possuem grande habilidade em influenciar pessoas. São animadas,
                entusiasmadas, extrovertidas e motivadoras. Sabem persuadir, se comunicar e manter o otimismo.
                Entretanto, essas pessoas constantemente iniciam projetos e não os terminam, e seu entusiasmo pode
    ...
    <div class="modalestabilidade" id="modalestabilidade">
        <div class="scrollop">
            ...
            <p>Frase: “Seria melhor uma abordagem mais calma”<br>
                ...
                São pessoas que lidam melhor com rotinas e padrões. São paciêncientes, tranquilas, confiáveis, leais,
                persistentes e gentis. Por outro lado, a estabilidade muitas vezes é acompanhada pelo medo das mudanças
                e uma grande falta de iniciativa. Pessoas com essa tendência de comportamento possuem dificuldade em
                lidar com conflitos.
            </p>
        </div>
    </div>
    ...
    <div class="modalcautela" id="modalcautela">
        <div class="scrollop">
            ...
            <p>Frase: “Eu gosto de fazer as coisas do jeito certo”<br>
                ...
                São pessoas que possuem uma maior facilidade em lidar com regras e processos. São metódicas, analíticas,
                técnicas e determinadas. Elas seguem ordens e normas, e realizam suas tarefas com um cuidado exemplar.
                Por serem muito perfeccionistas, tendem a se perder em detalhes e são extremamente críticas — tanto com
                elas mesmas, quanto com as outras pessoas.
            </p>
        </div>
    </div>
        ...
        <center>
            <form class="login" method="POST" action="funcoes/validalogin.php">
                ...
                <div class="border">
                    ...
                    <br>
                    <a style="font-size: 15px" class="esqueceuSenha" onclick="mostraEsqueceuSenha()">Esqueceu a
                        senha?</a><BR>
    ...
    <div id="esqueceuSenha" style="display: none">
        ...
        <center>
            <form class="login" method="POST" action="funcoes/esqueceusenha.php">
    ...
    <div class="modalalert" style="display: block;" id="modalalert">
        <div class="content">
            <div class="scroll">
                <center>
        ...
        </div><?php unset($_SESSION['loginErro']); ?>
    ...
    <div id="escolhaCadastro" style="display: none">
        ...
        <div class="escolhacadastro">
            <div class="links"><a href="index.php"
                    style="text-decoration: none; font-size: 20px; color:#fff">Home</a><span> > </span><a
                    style="font-size: 20px">Cadastrar</a> </div>
            <br><br>
            ...
            <form class="usuario" method="POST" action="funcoes/cadastrausuario.php">
                ...
                <div class="centraliza">
                    <div class="dadospessoais">
                        ...
                        <label>CPF:</label>
                        <input type="text" name="cpf1" onkeypress="return mask(event, this, '###.###.###-##')"
                            maxlength="14" required id="cpf1">
                        <input style="display: none" type="text" name="telefone_usuario" required id="telefone_usuario">
                        <label>Telefone:</label>
                        <input type="text" name="telefone1" maxlength="13"
                            onkeypress="return mask(event, this, '## #####-####')" required id="telefone1">
                    </div>
                    ...
                    <div class="empresa">
                        ...
                        <div class="submit-line">
                            ...
                            <a class="submit-lente" href="#"
                                onMouseOver="toolTip('Este é o código que o RH/Psicólogo te informou, caso não tenha o mesmo entre em contato com o responsável, solicitando o código de acesso para realizar a avaliação DISC.', 200)"
                                onMouseOut="toolTip()">
                ...
                <div style=" margin: 0 auto; width: 50%; height: 10%; ">
                    ...
                    <label style=" font-size: 12px; "> <input style="width: 20px; margin-top: 20px;" type="checkbox"
                            required> Li e concordo com os <a target="_blanck" style="font-size: 12px; color:#fff;"
                            href="privacidade.php">Termos de Uso.</a></label>
                </div>
            ...
            <form class="rh" method="POST" action="funcoes/cadastrarh.php">
                ...
                <div class="centraliza">
                    <div class="dadospessoais">
                        ...
                        <input type="text" name="cpf2" onkeypress="return mask(event, this,'##.###.###/####-##')"
                            maxlength="18" required id="cpf2">
                        <input style="display: none" type="text" name="telefone_rh" required id="telefone_rh">
                        <label>Telefone:</label>
                        <input type="tel" name="telefone2" maxlength="13"
                            onkeypress="return mask(event, this, '## #####-####')" required id="telefone2">
                    </div>
                    ...
                    <div class="empresa">
                        ...
                        <div class="submit-line">
                            ...
                            <a class="submit-lente" href="#"
                                onMouseOver="toolTip('Crie um código único que deverá ser informado para o candidato, para que o mesmo possa fazer o cadastro, e a avaliação ser direcionada para seu perfil', 200)"
                                onMouseOut="toolTip()">
                                <i class="fa fa-question-circle" style="font-size:35px; color:#fff"></i>
                            </a>
                        </div>
    ...
    function confirmaSenha2() {
        ...
        if (cel.length === 11 || cel.length === 10) {
            ...
            document.getElementById("alerta_rh").innerHTML =
            "Por favor preencha o campo telefone com 11 ou 10 numeros!";
    ...
    document.getElementById("alerta_rh").style.padding = '20px';
    document.getElementById("alerta_rh").innerHTML =
        "Este email já está cadastrado em usuario que será avaliado, escolha outro!";
    document.getElementById("rh").scrollTo(0, 0);
    mostraRh();
    </script><?php
    ...
    document.getElementById("alerta").innerHTML =
        "Não existe nenhum RH/Psicólogo com este código, por favor tente novamente!";
    document.getElementById("usuario").scrollTo(0, 0);
    mostraUsuario();
    </script><?php
